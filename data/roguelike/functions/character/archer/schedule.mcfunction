...
tellraw @a[tag=archer,scores={ar_skill=45},nbt=!{Inventory:[{id:"minecraft:crossbow",tag:{tech:1b}}]}] {"text":"[클래스 PVP] 테크니컬 활 사용 가능","color":"gray","bold":false,"italic":false}
tellraw @a[tag=archer,scores={ar_poison=25},nbt=!{Inventory:[{id:"minecraft:crossbow",tag:{poison:1b}}]}] {"text":"[클래스 PVP] 독 다트 사용 가능","color":"gray","bold":false,"italic":false}
